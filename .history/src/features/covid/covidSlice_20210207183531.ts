...
export const selectData = (store: RootState) => store.covid.data;
export const selectDailyData = (store: RootState) => store.covid.dailyData;
export const selectCountry = (store: RootState) => store.covid.country;
